...
export default function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 sm:top-0 sm:bottom-auto w-full z-50 flex items-center justify-between sm:px-6 sm:py-3 px-4 py-2">
      ...
      {/* Tengah */}
      <div className="mt-2 bg-gray-900/50 backdrop-blur-lg shadow-md rounded-full flex px-4 py-2 sm:px-6 sm:py-3 space-x-2 sm:space-x-4 max-w-full mx-auto mb-5">
